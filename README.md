...
Open http://localhost:3001 — the landing page links to both UIs:

- **http://localhost:3001/editor** — create and edit virtual tools and agents
- **http://localhost:3001/registry** — browse what's in the registry

**Tool Editor** — `/editor`. You'll see three panels:
...
editor/
  home.html              # Landing page linking to editor and registry browser
  index.html             # /editor — visual tool builder (three-panel UI)
  registry.html          # /registry — browse tools, agents, servers, schemas, lineage
